...
blue=(0, 0, 255)
yellow=(255, 255, 0)
blackcake= pygame.image.load("cake.png")
bigexplosion= pygame.image.load("Explosion.png")
tank= pygame.image.load("warmachine.png")
monkey1= pygame.image.load("monkey 1.png")
baboon1= pygame.image.load("baboon.png")
bigexplosion = pygame.transform.scale(bigexplosion , (100,100))
...
SUBTITLE_FONT=pygame.font.SysFont('comicsans', 60)
...
blackcake = pygame.image.load('cake.png')
blackcake = pygame.transform.scale(blackcake , (100,100))
monkey1 = pygame.image.load('monkey 1.png')
monkey1 = pygame.transform.scale(monkey1, (100,100))
baboon1 = pygame.image.load('baboon.png')
baboon1 = pygame.transform.scale(baboon1, (100,100))
def display_Title(message,ym):
    ...
    pygame.time.delay(100)
def display_Subtitle(message,ym):
    pygame.time.delay(100)
...
def Menu_function(line):
    ...
    for i in range(0,len(line)):
        word=line[i]
        pygame.draw.rect(win, LIGHTBLUE, square)
...
def SettingMenuWin(xm,ym):
    ...
    if xm>=70 and xm<=95 and ym>=250 and ym<=275 and flag: #71, 193. 93,193. 93, 212. 71, 211
        win.fill(COLOR)
        display_Title("BG COLORS",  70)
        display_Subtitle("RED", 250)
        display_Subtitle("Blue", 320)
        display_Title("BACK", 600)
        pygame.display.update()
        BACKGROUND = True
        SETTINGS = False             
...
def Screen_size():
    ...
    for i in range(0,len(squaresSize)):
        ...
        xm +=200
def game_Mainmenu():
    win.blit(blackcake, (0,0))
    win.blit(tank, (400,0))
    win.blit(bigexplosion, (300,0))
    pygame.display.set_caption("Easy Mode")
...
def game_Settings():
    win.blit(monkey1, (0,0))
    win.blit(baboon1, (600,0))
